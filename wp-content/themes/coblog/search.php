    ...
    <main id="main" class="site-main">
        <div class="container">
            <h1 class="coblog-page-title">
                <?php
                printf( esc_html__( 'Search Results for: %s', 'coblog' ), '<span>' . get_search_query() . '</span>' );
                ?>
            </h1>
            <?php 
            ...
            <?php 
            if ( have_posts() ) : ?>
                <div class="coblog-layout-wrap <?php echo $coblog_archive_layout?>">
                    <?php if ( $coblog_archive == 'left' ) { get_sidebar();}?>        
                    <div class="coblog-layout-inside">    
                        <div class="coblog-post-column coblog-post-column<?php echo $coblog_column;?>">
                            <?php
                            while ( have_posts() ) :
                                the_post();
